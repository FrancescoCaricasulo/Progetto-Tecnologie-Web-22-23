...
function login(){
	...
	if($('#user1').val() && $('#pass1').val() && isValidInput(document.getElementById('user1').value) && isValidInput(document.getElementById('pass1').value) ){
		var us = $('#user1').val();
		var pas = $('#pass1').val();
		$.ajax({
			type: "POST",
...
//Funzione per controllare se il testo inserito è corretto, evito possibili SQLInjection
